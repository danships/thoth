...
| `SEARCH_INDEX_VERSION` | No | `2` | Search index schema/version tag. Bump this whenever the search document formatter, chunking, embedding model/options, or other on-disk search-index assumptions change; the next open rebuilds the workspace index automatically. |
